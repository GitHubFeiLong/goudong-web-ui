...
function sendEmail(){
    ...
    if(registUsername == "" || registUsername == null){
        ...
        // 异步发送邮件
        let apiUrl = convertParamUrlRipe(apiUserRegistSendEmail, registUsername)
        $.ajax({
            url:apiUrl,
            type:"post",
            dataType:"json",
...
function regist(){
    ...
    if(registUsername == "" || registUsername == null){
        ...
        // 异步发送邮件
        var params = [registUsername, registPassword, registPin]
        let apiUrl = convertParamsUrlRipe(apiUserRegistUser, params)
        $.ajax({
            url: apiUrl,
