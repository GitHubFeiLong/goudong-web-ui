...
function login() {
    ...
    if (boo1 && boo2) {
        // 异步发送邮件
        var params = [loginUsername, loginPassword, rememberPassword]
        let apiUrl = convertParamsUrlRipe(apiUserLogin, params)
        $.ajax({
            url: apiUrl,
            type: "get",
            dataType: "json",
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                switch (jqXHR.status) {
                    ...
                    case 404:
                        ...
                        break;
                    default:
                        setErrorDataToLocalStorage(jqXHR.responseJSON);
                        break;
                }
...
//    "width=450,height=320,menubar=0,scrollbars=1,resizable=1,status=1,titlebar=0,toolbar=0,location=1");
    var A=window.open("http://www.goudong.shop/oauth/qq/login","TencentLogin","width=450,height=320,menubar=0,scrollbars=1,resizable=1,status=1,titlebar=0,toolbar=0,location=1");
})