<template>
  ...
  <IndexSecKill/>
  <IndexActivityFloor/>
  <IndexFeatureOptimizationDaySpecialPrice/>
...
import IndexFeatureOptimizationDaySpecialPrice from "@/pages/index/components/IndexFeatureOptimizationDaySpecialPrice.vue";
