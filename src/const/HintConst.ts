...
export const USERNAME_HINT_0 = new RegistHint('支持中文、英文、数字、“-”、“_”的组合，4-20个字符', '#c5c5c5', '0px -100px');
export const USERNAME_HINT_1 = new RegistHint('格式错误，仅支持汉字、字母、数字、“-”、“_”的组合', '', '');
// 注册输入密码
